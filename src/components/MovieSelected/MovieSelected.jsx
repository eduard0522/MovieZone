    ...
    <>
      <section className='flex w-full gap-8 justify-between'>
        <section className='w-3/5'>
          ...
          <div className='my8 flex flex-col gap-4'>
            <div className='flex justify-between'>
              ...
              <div className='flex gap-4'>
                ...
                <div className='flex flex-col items-center text-sm text-blackP-100 cursor-pointer group'>
                  <BiSolidLike className='text-xl font-bold group-hover:text-blueP ' />
                  <span>Me gusta</span>
                </div>
                <div className='flex flex-col items-center text-sm text-blackP-100 cursor-pointer group'>
                  <BiLike className='text-xl font-bold group-hover:text-blueP ' />
